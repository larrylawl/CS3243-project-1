...
\paragraph
The three informed searches were tested against 3 x 3 puzzles of varying difficulty and their runtimes are plotted against the number of steps it took to achieve goal states. To minimize bias, the searches were tested against 30 different puzzles for each number of steps needed to achieve goal states and the average of the 30 runtimes are taken. See
...
\end{document}
>>>>>>> 151a101746fa592eebf7c3a4765575cc89b1be15
