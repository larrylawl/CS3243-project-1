...
\begin{enumerate}
    ...
    \item \( k \) is even, the sum of \(n_i \) and \( i \) is odd
\end{enumerate}
...
\textbf{Proof for Consistency.} Found in appendix \ref{appendix:manhat_cons}.
...
\textbf{Proof for Consistency.} Found in appendix \ref{appendix:euc_cons}
